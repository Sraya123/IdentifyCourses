...
public class DataProviders {
	...
	@DataProvider(name = "CourseNameOne")
	public String[][] getData() throws IOException {
		String path = ".\\testData\\Courses_Name.xlsx";// taking xl file from testData
	...
	// DataProvider 2
	@DataProvider(name = "CourseNameTwo")
	public String[][] getDataTwo() throws IOException {
		String path = ".\\testData\\Courses_Name.xlsx";// taking xl file from testData
